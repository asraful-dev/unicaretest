            ...
            <div class="card-header">
               <div class="row">
                  ...
                  <div class="col-sm-6 text-right">
                     <a href="{{ route('tour.index') }}" class="btn btn-danger">
                ...
                <div class="row m-4">
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="text" name="title" value="{{ $tour->title }}" id="title" class="form-control" placeholder="Enter tour title">
                        @error('title')
                 ...
                 <div class="col-md-12">
                    <div class="form-group">
                       ...
                       <input type="text" name="tour_division[]" value="{{ $tour->tour_division }}" id="tags1" data-role="tagsinput" placeholder="Type and hit enter to add a division" class="form-control" required>
                       @error('tour_division')
                       <span class="text-danger">{{ $message }}</span>
                       @enderror
                    </div>
                 ...
                 <div class="col-md-12">
                    <div class="form-group">
                       ...
                       <input type="number" name="tour_day" min="0" value="{{ $tour->tour_day }}" id="tour_day" class="form-control" placeholder="Enter tour day">
                       @error('tour_day')
                       <span class="text-danger">{{ $message }}</span>
                       @enderror
                    </div>
                 ...
                 <div class="col-md-12">
                    <div class="form-group">
                       ...
                       <input type="text" name="tour_group" value="{{ $tour->tour_group }}" id="tour_group" class="form-control" placeholder="Enter tour group">
                       @error('tour_group')
                       <span class="text-danger">{{ $message }}</span>
                       @enderror
                    </div>
                 ...
                 <div class="col-md-12">
                    <div class="form-group">
                       ...
                       <input type="text" name="depture" value="{{ $tour->depture }}" id="depture" class="form-control" placeholder="Enter tour depture">
                       @error('depture')
                       <span class="text-danger">{{ $message }}</span>
                       @enderror
                    </div>
                 ...
                 <div class="col-md-12">
                    <div class="form-group">
                       ...
                       <input type="date" name="depture_time" value="{{ $tour->depture_time }}" id="depture_time" class="form-control" placeholder="Enter tour depture time">
                       @error('depture_time')
                       <span class="text-danger">{{ $message }}</span>
                       @enderror
                    </div>
                 ...
                 <div class="col-md-12">
                    <div class="form-group">
                       ...
                       <input type="date" name="return_time" value="{{ $tour->return_time }}" id="return_time" class="form-control" placeholder="Enter tour depture return time">
                       @error('return_time')
                       <span class="text-danger">{{ $message }}</span>
                       @enderror
                    </div>
                 ...
                 <div class="col-md-12">
                    <div class="form-group">
                       ...
                       <input type="text" name="dress_code[]" value="{{ $tour->dress_code }}" id="tags1" data-role="tagsinput" placeholder="Type and hit enter to add a dress code" class="form-control" required>
                       @error('dress_code')
                       <span class="text-danger">{{ $message }}</span>
                       @enderror
                    </div>
                 ...
                 <div class="col-md-12">
                    <div class="form-group">
                       ...
                       <input type="text" name="price_includes[]" value="{{ $tour->price_includes }}" id="tags1" data-role="tagsinput" placeholder="Type and hit enter to add a price includes" class="form-control" required>
                 ...
                 <div class="col-md-12">
                    <div class="form-group">
                       ...
                       <input type="text" name="price_excludes[]" value="{{ $tour->price_excludes }}" id="tags1" data-role="tagsinput" placeholder="Type and hit enter to add a price excludes" class="form-control" required>
                 ...
                 <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="number" min="0" name="regular_price" class="form-control" id="regular_price" placeholder="Enter product regular price" value="{{ $tour->regular_price }}">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                        <label for="discount_price" class="form-label">Discount Price:</label>
                        <input type="number" min="0" name="discount_price" class="form-control" id="discount_price" placeholder="Enter product discount price" value="{{ $tour->discount_price }}">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
