                ...
                <div class="row m-4">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                       ...
                       <input type="text" name="tour_country" value="{{ old('tour_country') }}" id="tour_country" class="form-control" placeholder="Enter tour country" required>
                       @error('tour_country')
                       <span class="text-danger">{{ $message }}</span>
                       @enderror
                    </div>
                 ...
                 <div class="col-md-12">
                    <div class="form-group">
                       ...
                       <input type="text" name="tour_division[]" value="{{ old('tour_division') }}" id="tags1" data-role="tagsinput" placeholder="Type and hit enter to add a division" class="form-control" required>
                       @error('tour_division')
                       <span class="text-danger">{{ $message }}</span>
                       @enderror
                    </div>
                 ...
                 <div class="col-md-12">
                    <div class="form-group">
                       ...
                       <input type="text" name="dress_code[]" value="{{ old('dress_code') }}" id="tags1" data-role="tagsinput" placeholder="Type and hit enter to add a dress code" class="form-control" required>
                       @error('dress_code')
                       <span class="text-danger">{{ $message }}</span>
                       @enderror
                    </div>
                 ...
                 <div class="col-md-12">
                    <div class="form-group">
                       ...
                       <input type="text" name="price_includes[]" value="{{ old('price_includes') }}" id="tags1" data-role="tagsinput" placeholder="Type and hit enter to add a price includes" class="form-control" required>
                 ...
                 <div class="col-md-12">
                    <div class="form-group">
                       ...
                       <input type="text" name="price_excludes[]" value="{{ old('price_excludes') }}" id="tags1" data-role="tagsinput" placeholder="Type and hit enter to add a price excludes" class="form-control" required>
