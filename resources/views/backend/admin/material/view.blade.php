            ...
            <div class="card-body">
               <div class="table-responsive">
                  <table class="table table-bordered">
                     <tr>
                        <td>Book Title</td>
                        <td>{{ $material->book_title ?? 'NULL' }}</td>
                     </tr>
                     <tr>
                        <td>Author</td>
                        <td>{{ $material->author ?? 'NULL' }}</td>
                     </tr>
                     <tr>
                        <td>Related Topics</td>
                        <td>{{ $material->related_topics ?? 'NULL' }}</td>
                     </tr>
                     <tr>
                        <td>Status</td>
                        <td>
                     ...
                     <tr>
                        ...
                        <td>
                           <img src="{{ asset($material->image) }}" alt="Material Image" style="height:70px; width:80px;">
                        </td>
                     </tr>
                  </table>
               </div>
