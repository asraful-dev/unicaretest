            ...
            <div class="ps-form__content">
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-md-12">
                        <!-- Merged Payment Information and Nagad Payment Section -->
                        <div class="payment-section border rounded p-4 mb-5 shadow-sm bg-white">
                            <div class="row mb-4 align-items-center">
                                <div class="col-lg-8 col-md-12 mb-4 mb-lg-0">
                                    <h2 class="text-danger">নগদ পেমেন্ট</h2>
                                    <p>আপনার নগদ মেনু থেকে পেমেন্ট নির্বাচন করতে হবে</p>
                                </div>
                                <div class="col-lg-4 col-md-12 text-center">
                                    <img class="img-fluid" src="https://eshopttka.com/frontend/payment/nagad-manual-payment-banner.png" alt="Nagad Payment">
                                </div>
                            </div>
                            <h2 class="bg-danger text-light text-center p-3 rounded">To Pay by Nagad Follow the Instructions Below:</h2>
                            <div class="mt-4">
                                <h3>Payment Procedure:</h3>
                                <ul class="list-group">
                                    <li class="list-group-item">01. *167# ডায়াল করে নগদ মোবাইল মেনু্তে যান</li>
                                    <li class="list-group-item">02. "পেমেন্ট সিলেক্ট করুন"</li>
                                    <li class="list-group-item">03. আমাদের মার্চেন্ট নগদ একাউন্ট নাম্বারটি প্রবেশ <span class="text-danger">({{ $wallet->nagad }})</span> করুন</li>
                                    <li class="list-group-item">04. ইনভয়েস এর মোট Example @if($service->discount_price)
                                        {{ number_format($service->price - $service->discount_price) }}
                                    @else
                                        {{ number_format($service->price) }}
                                    @endif টাকা প্রবেশ করুন</li>
                                    <li class="list-group-item">05. রেফারেন্স হিসেবে 112 এই নাম্বারটি প্রবেশ করুন</li>
                                    <li class="list-group-item">06. আপনার নগদ মোবাইল মেনু পিনটি দিয়ে পেমেন্ট সম্পন্ন করুন</li>
                            ...
                            <div class="payment-method-section mt-4">
                                <h4 class="text-primary">Nagad Payment</h4>
