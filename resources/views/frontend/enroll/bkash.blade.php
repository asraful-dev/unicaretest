            ...
            <div class="ps-form__content">
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-md-12">
                        <!-- Merged Payment Information and Bkash Payment Section -->
                        <div class="payment-section border rounded p-4 mb-5 shadow-sm bg-white">
                            <div class="row mb-4 align-items-center">
                                <div class="col-lg-8 col-md-12 mb-4 mb-lg-0">
                                    <h2 class="text-danger">বিকাশ পেমেন্ট </h2>
                                    <p>আপনার বিকাশ মেনু থেকে পেমেন্ট নির্বাচন করতে হবে</p>
                                </div>
                                <div class="col-lg-4 col-md-12 text-center">
                                    <img class="img-fluid" src="https://eshopttka.com/frontend/payment/bkash_payment.png" alt="Bkash Payment">
                                </div>
                            </div>
                            <h2 class="bg-danger text-light text-center p-3 rounded">To Pay by Bkash Follow the Instructions Below:</h2>
                            <div class="mt-4">
                                <h3>Payment Procedure:</h3>
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">1. Dial *247#</li>
                                    <li class="list-group-item">2. Choose "Payment"</li>
                                    <li class="list-group-item">3. Enter Unicare Bkash No <span class="text-danger">({{ $wallet->bkash }})</span></li>
                                    <li class="list-group-item">4. Enter the amount, e.g., BDT 
                                    ...
                                    @endif
                                    for your order</li>
                                    <li class="list-group-item">5. Enter Order ID as your reference</li>
                                    <li class="list-group-item">6. Enter the counter number (1)</li>
                                    <li class="list-group-item">7. Enter your Bkash PIN to confirm</li>
                                </ul>
                                <h2 class="text-center mt-3">Then Click the "Make Payment" Button</h2>
                            </div>
                            
                            <!-- Shipping and User Information -->
                            ...
                            <div class="payment-method-section mt-4">
                                <h4 class="text-primary">Bkash Payment</h4>
