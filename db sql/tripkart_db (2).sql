...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 11, 2024 at 05:35 PM
...
(139, '2024_06_08_093104_create_wallets_table', 26),
(141, '2024_06_08_105154_create_payments_table', 27),
(143, '2024_06_10_053223_create_payments_table', 28);
...
CREATE TABLE `our_services` (
  ...
  `course_type` tinyint(1) DEFAULT NULL COMMENT '1=>Online Course, 0=>Offline Course',
  `status` tinyint(3) UNSIGNED NOT NULL DEFAULT 0 COMMENT '1=>Active, 0=>Inactive',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `our_services` (`id`, `unit`, `image`, `one_facility`, `two_facility`, `three_facility`, `price`, `discount_price`, `course_type`, `status`, `created_at`, `updated_at`) VALUES
(59, 1, 'upload/OurService/1801274020656840.png', 'Week Test 10', 'Model Test 5', 'Experienced and medhabi teacher class niba', 1500, 400, 1, 1, '2024-06-08 00:39:30', '2024-06-08 00:39:30'),
(60, 2, 'upload/OurService/1801274259750767.png', 'Week Test 10', 'Model Test 5', 'Experienced and medhabi teacher class niba', 3000, 500, 1, 1, '2024-06-08 00:43:18', '2024-06-08 00:43:18'),
(61, 3, 'upload/OurService/1801274306180522.png', 'Week Test 10', 'Model Test 5', 'Experienced and medhabi teacher class niba', 2500, 500, 1, 1, '2024-06-08 00:44:03', '2024-06-08 00:44:03'),
(62, 4, 'upload/OurService/1801274331653697.jpg', 'Week Test 10', 'Model Test 5', 'Experienced and medhabi teacher class niba', 1500, 100, 1, 1, '2024-06-08 00:44:27', '2024-06-08 00:44:27'),
(63, 5, 'upload/OurService/1801274391302893.png', 'Week Test 10', 'Model Test 5', 'Experienced and medhabi teacher class niba', 1500, 100, 1, 1, '2024-06-08 00:45:23', '2024-06-08 00:45:24'),
(64, 1, 'upload/OurService/1801274489260275.png', 'Week Test 10', 'Model Test 5', 'Experienced and medhabi teacher class niba', 1700, 400, 0, 1, '2024-06-08 00:46:57', '2024-06-08 00:46:57');
...
CREATE TABLE `payments` (
  ...
  `payment_status` bigint(20) UNSIGNED DEFAULT 0 COMMENT '1=>paid, 0=>Unpaid',
...
INSERT INTO `payments` (`id`, `user_id`, `payment_method`, `payment_status`, `transaction_id`, `sender_number`, `email`, `total_amount`, `screenshot`, `created_at`, `updated_at`) VALUES
(54, 37, 'bkash', 0, '935585', '01944404906', 'student@gmail.com', '1100', 'uploads/1718022319_Screenshot_2.png', '2024-06-10 06:25:19', '2024-06-10 06:25:19'),
(55, 37, 'bkash', 0, '4548574', '01245', 'student@gmail.com', '1100', 'uploads/1718022418_Screenshot_2.png', '2024-06-10 06:26:58', '2024-06-10 06:26:58'),
(56, 37, 'rocket', 0, '4545', '45245', 'student@gmail.com', '1100', 'uploads/1718022625_Screenshot_3.png', '2024-06-10 06:30:25', '2024-06-10 06:30:25');
...
(31, 59, 'bangla', 2, 'Brain Test', 25, '2024-06-08 00:39:30', '2024-06-08 00:39:30'),
(32, 60, 'Accounting', 100, '14', 300, '2024-06-08 00:43:18', '2024-06-08 00:43:18'),
(33, 61, 'Accounting', 25, '14', 25, '2024-06-08 00:44:03', '2024-06-08 00:44:03'),
(34, 62, 'Physics', 100, '5', 300, '2024-06-08 00:44:27', '2024-06-08 00:44:27'),
(35, 63, 'bangla', 2, 'Brain Test', 25, '2024-06-08 00:45:24', '2024-06-08 00:45:24'),
(36, 64, 'Accounting', 25, '14', 25, '2024-06-08 00:46:57', '2024-06-08 00:46:57');
...
(19, 'Admin', 'admin', 'admin@gmail.com', NULL, '$2y$10$lIyLzidohdarNEOaN581Tu66vnO7lLnCJVvCDzpNp9kcVcPsGweaq', 'profile_images/1716959501.jpg', '01768603251', NULL, 'Shahzadpur Sirajganj, Shahzadpur Sirajganj Bangladesh', NULL, NULL, 'admin', 'active', '2024-06-10 12:56:41', NULL, NULL, '2024-06-10 06:56:41'),
...
(37, 'student', 'student', 'student@gmail.com', NULL, '$2y$10$oidl7dTNfzH7PTaXWKCdguyj3L1Xed8o4Ky4z7xT8ret4z5PLVOIC', 'upload/user_images/1800933365570178.jpg', '017xxxxxxx', 'Dhaka University Of Bangladesh', 'Mirpur,Dhaka', NULL, NULL, 'user', 'active', '2024-06-10 12:32:24', NULL, '2024-06-04 06:24:56', '2024-06-10 06:32:24'),
...
CREATE TABLE `wallets` (
  ...
  `nagad` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `rocket` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `wallets` (`id`, `bkash`, `nagad`, `rocket`, `created_at`, `updated_at`) VALUES
(1, '01768603251', '01768603251', '01768603251', '2024-06-08 10:25:17', '2024-06-08 04:38:26');
